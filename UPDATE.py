...
#Permite Actualizar datos(UPDATE)

print("\nActualizando Nombre de  la fuente de emisión 1:")
db_connector.execute_insert_procedure('actualizarNombreFuenteEmision',1, "Combustibles fósiles (calderas_calefacción)")

print("\nMostrando detalles de todas las fuentes de emisión después de la actualización:")
